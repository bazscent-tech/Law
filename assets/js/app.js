        ...
        function toggleFollow(btn) {
            ...
            if (isFollowing(author)) { followingUsers = followingUsers.filter(a => a !== author); saveFollowing(); showToast('تم إلغاء المتابعة'); }
            else { followingUsers.push(author); saveFollowing(); btn.style.transform = 'scale(1.1)'; setTimeout(() => btn.style.transform = '', 200); showToast('تمت المتابعة ✓'); }
