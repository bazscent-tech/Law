...
-- ============================================================
-- جداول المكتبة الشخصية (Personal Library)
-- ============================================================
...
CREATE INDEX idx_library_items_author ON public.library_items(author_id);
...
CREATE INDEX idx_library_saves_user ON public.library_saves(user_id);
CREATE INDEX idx_library_follows_user ON public.library_follows(user_id);
